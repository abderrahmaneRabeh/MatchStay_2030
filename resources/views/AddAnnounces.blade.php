...
<head>
    ...
    <title>StayMorocco - Add New Announce</title>
...
<body class="font-sans bg-gray-50 text-dark" x-data="{ mobileMenu: false }">
    ...
    <!-- Add Announce Form Section -->
    <section class="pt-32 pb-12 bg-gradient-to-r from-primary to-secondary">
        <div class="container px-6 mx-auto">
            <div class="max-w-3xl text-white">
                <h1 class="mb-4 text-4xl font-bold">Add New Announce</h1>
                <p class="text-lg opacity-90">Fill out the form below to list your property.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container px-6 py-12 mx-auto">
        <div class="p-8 bg-white rounded-lg shadow-lg">
            <form action="/AddAnnounce" method="POST" class="space-y-6">
                @csrf <!-- CSRF Token for security -->

                <!-- Titre -->
                <div>
                    <label for="titre" class="block text-sm font-medium text-gray-700">Title</label>
                    <input type="text" name="titre" id="titre" required class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter property title">
                </div>

                <!-- Description -->
                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea name="description" id="description" rows="4" required class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter property description"></textarea>
                </div>

                <!-- Localisation -->
                <div>
                    <label for="localisation" class="block text-sm font-medium text-gray-700">Location</label>
                    <input type="text" name="localisation" id="localisation" required class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter property location">
                </div>

                <!-- Equipements -->
                <div>
                    <label for="equipements" class="block text-sm font-medium text-gray-700">Amenities</label>
                    <input type="text" name="equipements" id="equipements" required class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter amenities (separated by commas)">
                </div>

                <!-- Disponibilites -->
                <div>
                    <label for="disponibilites" class="block text-sm font-medium text-gray-700">Availability Date</label>
                    <input type="date" name="disponibilites" id="disponibilites" required class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none">
                </div>

                <!-- Image URL -->
                <div>
                    <label for="image_url" class="block text-sm font-medium text-gray-700">Image URL</label>
                    <input type="url" name="image_url" id="image_url" class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter image URL (optional)">
                </div>

                <!-- Prix -->
                <div>
                    <label for="prix" class="block text-sm font-medium text-gray-700">Price per Night</label>
                    <input type="number" name="prix" id="prix" step="0.01" class="w-full p-3 mt-1 border-0 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary focus:outline-none" placeholder="Enter price (optional)">
                </div>

                <!-- Submit Button -->
                <div>
                    <button type="submit" class="w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-primary hover:bg-secondary">Submit Announce</button>
                </div>
            </form>
        </div>
    </section>
